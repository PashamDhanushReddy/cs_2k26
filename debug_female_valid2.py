...
def test_female_validation_valid():
    ...
    data = {
        ...
        'member1_year': '3',
        'is_leader1': True,  # Try with boolean True
    ...
    if not form.is_valid():
        ...
        # Check what leader fields are set
        print("\nLeader fields:")
        for i in range(1, 7):
            field_name = f'is_leader{i}'
            value = form.cleaned_data.get(field_name) if form.cleaned_data else 'N/A'
