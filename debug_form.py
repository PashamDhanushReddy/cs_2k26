...
def test_form_validation():
    ...
    # Test team size 5 with missing member 5
    data = {
        'team_name': 'TestTeam',
        'team_size': '5',
    ...
    # Test invalid phone
    data['member1_phone'] = '1234567890'  # Invalid - starts with 1
    form2 = TeamRegistrationForm(data=data)
    print(f"Form with invalid phone is valid: {form2.is_valid()}")
    if not form2.is_valid():
        print("Phone validation errors:")
